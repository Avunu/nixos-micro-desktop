    ...
    in
    {
      ...
      nixosModules.microDesktop =
        ...
        let
          ...
          microFcitx5Theme =
            pkgs.runCommand "micro-fcitx5-theme" { nativeBuildInputs = [ pkgs.librsvg ]; } ''
              ...
              fcitx5 = {
                ...
                settings = {
                  globalOptions = {
                    ...
                    # Candidate nav for both pickers: Up/Down = prev/next
                    # candidate, Left/Right (+ Page_Up/Down) = paging.
                    "Hotkey/PrevCandidate"."0" = "Up";
                    "Hotkey/NextCandidate"."0" = "Down";
                    "Hotkey/PrevPage" = {
                      "0" = "Left";
                      "1" = "Page_Up";
                    };
                  ...
                  addons = {
                    ...
                    waylandim.globalSection.PersistentVirtualKeyboard = "True";
                  };
                };
              };
            };
